...
<section class="container mt-4 ">
            ...
            <div class="card my-4 text-center shadow col-md-3" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">${book.getCategory().getName()}</p>
                         ...
                         <a href="/deleteBook2?id=${book.getId()}" > delete </a>
    ...
    <div align="center">
        ...
        <a href="deleteBook?page=<%=prev%>">  <button class="button button2">Previous</button> </a>

        <a href="deleteBook?page=${1}"> ${1}</a>
        <a href="deleteBook?page=${2}"> ${2}</a>

        <a href="deleteBook?page=<%=next%>">  <button class="button button5">Next</button> </a>
